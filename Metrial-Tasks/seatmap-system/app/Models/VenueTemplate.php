...
class VenueTemplate extends Model
{
     ...
     *
     * @param Collection $elements All active template elements
     * @return array<string, string> List of violation messages
     */
    private function validateAccessibilityProximity(Collection $elements): array
    {
        $violations = [];
        $toiletMaxDistM = 30;
        $musterMaxDistM = 50;
     ...
     */
    private function findNearestElementDistance(TemplateElement $reference, Collection $targets): float
    {
     ...
     * @return Collection
     */
    private function findElementsInRadius(TemplateElement $center, float $radiusMeters, array $excludedTypes = []): Collection
    {
